...
def churn_prediction(input_data):
    try:
        ...
        return 'Invalid input. Please enter valid values for all fields.'
...
def main():
    ...
    Like_Dislike = st.number_input('Did the subscriber like the video?')
    IsActiveMember = st.number_input('Is the subscriber active?')
